...
# RUNNER_TEMP may be backed by a small /run filesystem. Use the workspace disk
# for the observer's data and log files, still unique to this disposable job.
runtime_dir=$(mktemp -d "$GITHUB_WORKSPACE/ob-grant.XXXXXX")
